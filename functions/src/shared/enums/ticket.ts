export enum TicketStage {
  ...
  ToDo = 'todo',  // Only board has the power to move tickets here,
         // tickets landing here will trigger a function that activates the CEO
         ...
         // Either way the ticket stage will be updated to Doing
