...
import {Entity, Resource, Timestamps} from '../interfaces';
...
// firebase admin only
export interface MirrorTicket {
  ticketPath: FirebaseFirestore.DocumentReference;
  deadline: number; // millis
  assignedTo?: Entity;
  stage: TicketStage;
}
