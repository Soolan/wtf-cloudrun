...
import {AvatarPrompt, BannerPrompt, KeyValue, LogoPrompt} from '../interfaces';

export const projectId = 'wtf-workspace-ad6a4';
...
export const IMAGEN_3_FAST = 'imagen-3.0-fast-generate-001';
export const IMAGEN_3_FAST_ENDPOINT =
  `https://us-central1-aiplatform.googleapis.com/v1/projects/${projectId}/locations/us-central1/publishers/google/models/${IMAGEN_3_FAST}:predict`;
