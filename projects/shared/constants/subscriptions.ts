import {Balance, PlanFeature, Subscription} from '@shared/interfaces';
...
export const FREE_AI_MONTHLY_CREDIT: Balance = {currency: Currency.AI, amount: 5000};
export const BASIC_AI_MONTHLY_CREDIT: Balance = {currency: Currency.AI, amount: 25000};
export const PRO_AI_MONTHLY_CREDIT: Balance = {currency: Currency.AI, amount: 200000};

export const FREE_GB_CREDIT: number = 0.5;  // in GB
export const BASIC_GB_CREDIT: number = 5;
export const PRO_GB_CREDIT: number = 50;

export const PLAN_QUOTA: Record<Plan, Record<string, number>> = {
  free: {
    [Currency.AI]: FREE_AI_MONTHLY_CREDIT.amount,
    [Currency.GB]: FREE_GB_CREDIT,
  },
  basic: {
    [Currency.AI]: BASIC_AI_MONTHLY_CREDIT.amount,
    [Currency.GB]: BASIC_GB_CREDIT,
  },
  pro: {
    [Currency.AI]: PRO_AI_MONTHLY_CREDIT.amount,
    [Currency.GB]: PRO_GB_CREDIT,
  },
};
