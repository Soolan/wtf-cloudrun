import {MarketplaceInstallWithId, MarketplaceItemWithId, WtfQuery} from '@shared/interfaces';
...
export const MOCK_MARKETPLACE_ITEMS: MarketplaceItemWithId[] = [
  {
    ...
    publisher: {avatar: '',  role: 'author-001', name: 'John Doe' },
    verified: true,
    installs: 120,
    private: false,
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/150',
    publisher: {avatar: '',  role: 'author-002', name: 'Jane Smith' },
    verified: true,
    installs: 45,
    private: false,
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/150',
    publisher: {avatar: '',  role: 'author-003', name: 'Acme Inc' },
    verified: false,
    installs: 12,
    private: false,
  ...
  },
  {
    ...
    tags: ['ai', 'agent', 'sales'],
    logo: 'https://via.placeholder.com/150',
    publisher: {avatar: '', role: 'author-004', name: 'AI Experts' },
    verified: true,
    installs: 33,
    private: false,
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/150',
    publisher: {avatar: '',  role: 'author-005', name: 'Biz Solutions' },
    verified: false,
    installs: 8,
    private: false,
...
export const MOCK_MARKETPLACE_INSTALLS: MarketplaceInstallWithId[] = [
  {
    ...
    installedBy: { role: 'user-123', name: 'Current User', avatar: ''},
